import cv2
# Load an input image
image = cv2.imread(r"C:\Users\hp\Downloads\giri.jpeg") # Replace with your image path
if image is None:
...
# 5. Text
text_img = image.copy()
cv2.putText(text_img, "Experiment No 2 is Done!", (50, 300), cv2.FONT_HERSHEY_SIMPLEX, 1.2,
(255, 255, 255), 2)
